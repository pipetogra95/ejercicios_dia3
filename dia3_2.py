...
def actualizar_contacto(agenda):
    ...
    if nombre in agenda:
        ...
        nuevo_telefono = input("Agrega el número nuevo o presiona Enter si no deseas modificar:\n").strip()
        nuevo_email = input("Agrega el nuevo correo o presiona Enter si no deseas modificar:\n").strip()
        if nuevo_telefono:
